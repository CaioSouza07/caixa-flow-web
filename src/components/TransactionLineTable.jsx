...
function TransactionLineTable({ transaction }) {
  return (
    <tr className="flex justify-start items-center">
      <td className="text-left font-medium w-3/7">
      ...
      <td className="text-left font-medium w-1/7 text-[#64748B]/80">
        {transaction.date}
      </td>
      <td className="text-left font-medium w-1/7">
        <h2
      ...
      <td className="text-left font-medium w-2/7 text-[#64748B]/80">
        <div className="flex items-center gap-4">
          <Paperclip />
